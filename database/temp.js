...
module.exports.setInitialdata = function (_blockCount, _pricePerBlock, _rest, _timeLate, _balance, _requestAck, _previousTime) {
...
module.exports.setBP = function(newBP){
    BP = newBP;
}

module.exports.getBP = function(){
    return BP;
}
